...
# This module is using a modified version of the official oke-terraform-module that includes the ability to create 
# a policy for the operator host without the need of a dynamic group.
